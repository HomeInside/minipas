...
Ya hemos visto la [estructura básica de un programa](program_structure.md) en **minipas**, por lo que te resultará fácil comprender otros componentes básicos del lenguaje.
